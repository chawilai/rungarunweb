...
function setTheme(theme) {
  ...
  // if not light or contrast, set sidebar to light
  if (["light", "contrast", "system", "material"].includes(theme)) {
    config.value.sidebarTheme = "light";
  }
  if (["dark", "dim", "material-dark"].includes(theme)) {
    config.value.sidebarTheme = "dark";
  }
  updateAndApply();
}
        ...
        <div class="flex min-h-16 items-center justify-between gap-3 ps-5 pe-4">
          <Link href="/dashboards-ecommerce">
            <img
              ...
              :class="{ 'inline': config.sidebarTheme === 'dark' }"
              src="/nexus/images/logo/logo-dark.png"
            />
            <img
              alt="logo-light"
              class="h-5 dark:hidden"
              :class="{ 'hidden': config.sidebarTheme === 'dark' }"
            ...
            <div class="mb-3 space-y-0.5 px-2.5">
              ...
              <div class="group collapse">
                <input
                  ...
                  :checked="
                    isActive('/dashboards-ecommerce') ||
                    isActive('/dashboards-crm') ||
                    isActive('/dashboards-gen-ai')
                  "
                />
                ...
                <div class="collapse-content ms-6.5 !p-0">
                  <div class="mt-0.5 space-y-0.5">
                    <Link
                      ...
                      :class="{
                        active: isActive('/dashboards-ecommerce'),
                      }"
                    >
                    ...
                    <Link
                      ...
                      href="/dashboards-crm"
                      :class="{
                        active: isActive('/dashboards-crm'),
                      }"
                    >
                    ...
                    <Link
                      ...
                      :class="{
                        active: isActive('/dashboards-gen-ai'),
                      }"
                    >
              ...
              <div class="group collapse">
                <input
                  ...
                  name="sidebar-menu-parent-item"
                  :checked="
                    isActive('/apps-ecommerce-orders') ||
                    isActive('/apps-ecommerce-products') ||
                    isActive('/apps-ecommerce-sellers') ||
                    isActive('/apps-ecommerce-customers') ||
                    isActive('/apps-ecommerce-shops')
                  "
                />
                <div class="collapse-title px-2.5 py-1.5">
                ...
                <div class="collapse-content ms-6.5 !p-0">
                  <div class="mt-0.5 space-y-0.5">
                    <Link
                      ...
                      :class="{
                        active: isActive('/apps-ecommerce-orders'),
                      }"
                      ><span class="grow">Orders</span></Link
                    >
                    <Link
                      class="menu-item"
                      href="/apps-ecommerce-products"
                      :class="{
                        active: isActive('/apps-ecommerce-products'),
                      }"
                      ><span class="grow">Products</span></Link
                    >
                    <Link
                      class="menu-item"
                      href="/apps-ecommerce-sellers"
                      :class="{
                        active: isActive('/apps-ecommerce-sellers'),
                      }"
                      ><span class="grow">Sellers</span></Link
                    >
                    <Link
                      class="menu-item"
                      href="/apps-ecommerce-customers"
                      :class="{
                        active: isActive('/apps-ecommerce-customers'),
                      }"
                      ><span class="grow">Customers</span></Link
                    >
                    <Link
                      class="menu-item"
                      href="/apps-ecommerce-shops"
                      :class="{
                        active: isActive('/apps-ecommerce-shops'),
                      }"
                      ><span class="grow">Shops</span></Link
                    >
                  </div>
                </div>
                ...
                <div class="group collapse">
                  <input
                    ...
                    name="sidebar-menu-parent-item"
                    :checked="
                      isActive('/apps-genai-home') ||
                      isActive('/apps-genai-content') ||
                      isActive('/apps-genai-image') ||
                      isActive('/apps-genai-library')
                    "
                  />
                  <div class="collapse-title px-2.5 py-1.5">
                    ...
                    <span class="grow">Gen AI</span>
                    <span
                      class="iconify lucide--chevron-right arrow-icon size-3.5"
                    ></span>
                  </div>
                  <div class="collapse-content ms-6.5 !p-0">
                    <div class="mt-0.5 space-y-0.5">
                      <Link
                        class="menu-item"
                        href="/apps-genai-home"
                        :class="{
                          active: isActive('/apps-genai-home'),
                        }"
                        ><span class="grow">Home</span></Link
                      >
                      <Link
                        class="menu-item"
                        href="/apps-genai-content"
                        :class="{
                          active: isActive('/apps-genai-content'),
                        }"
                        ><span class="grow">Content</span></Link
                      >
                      <Link
                        class="menu-item"
                        href="/apps-genai-image"
                        :class="{
                          active: isActive('/apps-genai-image'),
                        }"
                        ><span class="grow">Image</span></Link
                      >
                      <Link
                        class="menu-item"
                        href="/apps-genai-library"
                        :class="{
                          active: isActive('/apps-genai-library'),
                        }"
                        ><span class="grow">Library</span></Link
                      >
                    </div>
                  </div>
                </div>
              ...
              <Link
                ...
                :class="{
                  active: isActive('/apps-file-manager'),
                }"
              >
              ...
              <Link
                class="menu-item"
                href="/apps-chat"
                :class="{ active: isActive('/apps-chat') }"
              >
                ...
                <div class="collapse-content ms-6.5 !p-0">
                  <div class="mt-0.5 space-y-0.5">
                    <Link
                      ...
                      ><span class="grow">Login</span></Link
                    >
                    <Link
                      class="menu-item"
                      href="/register"
                      ...
                      ><span class="grow">Register</span></Link
                    >
                    <Link
                      class="menu-item"
                      href="/forgot-password"
                      :class="{
                        active: isActive('/forgot-password'),
                      }"
                      ><span class="grow">Forgot Password</span></Link
                    >
                    <Link
                      class="menu-item"
                      href="/reset-password/demo-token"
                      :class="{
                        active: currentPath.startsWith('/reset-password'),
                      }"
                      ><span class="grow">Reset Password</span></Link
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="group collapse">
                <input
                  ...
                  class="peer"
                  name="sidebar-menu-parent-item"
                  :checked="isActive('/pages-settings') || isActive('/pages-get-help')"
                />
                <div class="collapse-title px-2.5 py-1.5">
                ...
                <div class="collapse-content ms-6.5 !p-0">
                  <div class="mt-0.5 space-y-0.5">
                    <Link
                      ...
                      ><span class="grow">Settings</span></Link
                    >
                    <Link
                      class="menu-item"
                      href="/pages-get-help"
                      :class="{
                        active: isActive('/pages-get-help'),
                      }"
                      ><span class="grow">Get Help</span></Link
                    >
                  </div>
                </div>
              </div>
      ...
      <div class="flex h-screen min-w-0 grow flex-col overflow-auto">
        ...
        >
          ...
          <div class="inline-flex items-center gap-0.5">
            ...
            >
              <span
                class="iconify lucide--sun absolute size-4.5 -translate-y-4 opacity-0 transition-all duration-300 group-data-[theme=light]/html:translate-y-0 group-data-[theme=light]/html:opacity-100"
              ></span>
              <span
                class="iconify lucide--moon absolute size-4.5 translate-y-4 opacity-0 transition-all duration-300 group-data-[theme=dark]/html:translate-y-0 group-data-[theme=dark]/html:opacity-100"
              ></span>
              <span
                class="iconify lucide--palette absolute size-4.5 opacity-100 group-data-[theme=dark]/html:opacity-0 group-data-[theme=light]/html:opacity-0"
              ></span>
            </button>
            <!-- Rightbar -->
            <label
      ...
      <div class="drawer-side z-[50]">
        ...
        <div class="bg-base-100 text-base-content h-full w-72 sm:w-96">
            ...
            <div class="inline-flex gap-1">
              ...
              >
                <span
                  ...
                  :class="{ inline: config.fullscreen }"
                ></span>
                <span
                  class="iconify lucide--fullscreen size-5 group-data-[fullscreen]/html:hidden"
                  :class="{ hidden: config.fullscreen }"
                ></span>
              </button>
              <label
                for="layout-rightbar-drawer"
          ...
          <div class="p-5">
            ...
            <div class="mt-3 grid grid-cols-3 gap-3">
              ...
              >
                ...
                <span
                  ...
                  :class="{ 'p-1 opacity-100': config.theme === 'light' }"
                ></span>
              </div>
              <div
                data-theme="contrast"
                ...
                @click.prevent="setTheme('contrast')"
              >
                <div class="bg-base-200 rounded-box pt-5 pb-3 text-center">
                  <div class="flex items-center justify-center gap-1">
                    <span class="rounded-box bg-primary h-6 w-2 sm:w-3"></span>
                ...
                <span
                  ...
                  :class="{ 'p-1 opacity-100': config.theme === 'contrast' }"
                ></span>
              </div>
              <div
                data-theme="material"
                ...
                @click.prevent="setTheme('material')"
              >
                <div class="bg-base-200 rounded-box pt-5 pb-3 text-center">
                  <div class="flex items-center justify-center gap-1">
                    <span class="rounded-box bg-primary h-6 w-2 sm:w-3"></span>
                ...
                <span
                  ...
                  :class="{ 'p-1 opacity-100': config.theme === 'material' }"
                ></span>
              </div>
              <div
                data-theme="dark"
              ...
              >
                ...
                <span
                  ...
                  :class="{ 'p-1 opacity-100': config.theme === 'dark' }"
                ></span>
              </div>
              <div
                data-theme="dim"
              ...
              >
                ...
                <span
                  ...
                  :class="{ 'p-1 opacity-100': config.theme === 'dim' }"
                ></span>
              </div>
              <div
                ...
                @click.prevent="setTheme('material-dark')"
              >
                <div class="bg-base-200 rounded-box pt-5 pb-3 text-center">
                  <div class="flex items-center justify-center gap-1">
                    <span class="rounded-box bg-primary h-6 w-2 sm:w-3"></span>
                ...
                <span
                  ...
                  :class="{ 'p-1 opacity-100': config.theme === 'material-dark' }"
                ></span>
              </div>
              <div
                class="rounded-box group relative cursor-pointer"
              ...
              >
                ...
                <span
                  ...
                  :class="{ 'p-1 opacity-100': config.theme === 'system' }"
                ></span>
              </div>
            </div>
            ...
            <div class="mt-6">
              ...
              <div class="mt-3 grid grid-cols-2 gap-3">
                <button
                  ...
                  :class="{ 'bg-base-200': (['light', 'contrast', 'system'].includes(config.theme) && config.sidebarTheme === 'light'), 'cursor-not-allowed': !['light', 'contrast', 'system'].includes(config.theme), 'cursor-pointer': ['light', 'contrast', 'system'].includes(config.theme) }"
                  @click="
                ...
                <button
                  class="border-base-300 hover:bg-base-200 rounded-box inline-flex items-center justify-center gap-2 border p-2"
                  :class="{ 'bg-base-200': (['light', 'contrast', 'system'].includes(config.theme) && config.sidebarTheme === 'dark'), 'cursor-not-allowed': !['light', 'contrast', 'system'].includes(config.theme), 'cursor-pointer': ['light', 'contrast', 'system'].includes(config.theme) }"
                  @click="
                    config.sidebarTheme = 'dark';
                    updateAndApply();
                  "
                >
            ...
            <p class="mt-6 font-medium" v-if="false">Direction</p>
            <div class="mt-3 grid grid-cols-2 gap-3" v-if="false">
              <div
